        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl">
            <form action="{{ route('posts.create') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="title" name="title" placeholder="Título de la publicación" value="{{ old('title') }}"
                ...
                <div class="mb-5">
                    ...
                    <textarea type="text" id="description" name="description" placeholder="Descripción de la publicación"
                           class="p-3 border w-full rounded-lg @error('description') border-red-500 @enderror">
                        {{ old('description') }}
                    </textarea>
